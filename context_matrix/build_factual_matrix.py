...
from factual_prototypes import FACTUAL_PROTOTYPES
from openai import OpenAI

client = OpenAI()

MODEL = "text-embedding-3-small"
BUNDLE_FILE = "factual_context_bundle.npz"
META_FILE = "factual_context_meta.json"
...
def build_context_bundle():
    ...
    for label, sentences in FACTUAL_PROTOTYPES.items():
...
def main():
    ...
    print("Factual context bundle built successfully")
